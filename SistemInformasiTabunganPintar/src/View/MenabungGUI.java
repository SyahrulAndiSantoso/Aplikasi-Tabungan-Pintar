...
public class MenabungGUI extends JFrame{
    ...
    int targetnabung,muriasetya07194_nominal,jangkawaktuterkumpul;
    public MenabungGUI() {
        menabung();
    }
    public void menabung(){
        ...
        nominal.setBounds(40, 70, 400, 40);
        ...
        btnsubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                    try{
                        ...
                        jangkawaktuterkumpul= targetnabung/muriasetya07194_nominal;
                       
                           if(targetnabung<=500000&&muriasetya07194_nominal<500000){
                       JOptionPane.showMessageDialog(null, "Anda disarankan menabung perhari ","information", JOptionPane.INFORMATION_MESSAGE);  
                    }else if(targetnabung>500000&&muriasetya07194_nominal<500000){
                           JOptionPane.showMessageDialog(null, "Anda disarankan menabung perhari ","information", JOptionPane.INFORMATION_MESSAGE);
                    }else{
            ...
            public void actionPerformed(ActionEvent ae){
                     ...
                     if(perhari.isSelected()){
                       ...
                       try{
                        ...
                        if(targetnabung==jangkawaktuterkumpul*muriasetya07194_nominal){   
                            tglmasuk.setText(sdf.format(calendar1.getTime()));
                                 calendar1.add(Calendar.DATE, jangkawaktuterkumpul);
                                     ...
                                     AllObjectController.user.InsertDataTabunganPintar(jangkawaktuterkumpul, targetnabung, muriasetya07194_nominal, muriasetya07194_nominal);                                
                        }else{
                                tglmasuk.setText(sdf.format(calendar1.getTime()));
                                 calendar1.add(Calendar.DATE, jangkawaktuterkumpul);
                                     tglterkumpul.setText(sdf.format(calendar1.getTime()));
